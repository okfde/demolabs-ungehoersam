...
/* A modified version of the Horsey library (https://github.com/bevacqua/horsey). Search for "CHANGED TW" to view the changes. */
...
function horsey(el) {
  ...
  var highlighter = options.highlighter; // CHANGED TW (added)
  var highlightCompleteWords = options.highlightCompleteWords;  // CHANGED TW (added)
  ...
  var completer = autocomplete(el, {
    ...
    anchor: anchor,
    noMatches: noMatches,
    highlighter: highlighter,  // CHANGED TW (added)
    highlightCompleteWords: highlightCompleteWords,  // CHANGED TW (added)
