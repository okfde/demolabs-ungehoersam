...
This is a browser-based editor app to generate interactive story consisting of multiple locations, which can then be read by the Ungehörsam Reader (or any other QR code reader). It was created as part of the workshop "Ungehörsam" by [Demokratielabore](https://demokratielabore.de).
...
The app is written in JavaScript ES6 and uses the following components:
* Client-side
  * [Aurelia](http://aurelia.io)
  * [aurelia-skeleton-navigation](https://github.com/aurelia/skeleton-navigation/tree/master/skeleton-esnext)
...
(These steps are taken from the [aurelia-skeleton-navigation](https://github.com/aurelia/skeleton-navigation/tree/master/skeleton-esnext) github project.)
